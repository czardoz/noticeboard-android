...
public class NewsRowAdapter extends ArrayAdapter<Item> {
	...
	String[] read_notices;
	public NewsRowAdapter(Activity act, int resource, List<Item> arrayList, String[] read_notices) {
		super(act, resource, arrayList);
		this.activity = act;
		this.row = resource;
		this.items = arrayList;
		this.read_notices=read_notices;
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		String notice_id=objBean.getId();
		for(String x : read_notices){
			if(x.compareTo(notice_id)==0){
